...
public class ImageProcessor {
    ...
    public ByteArrayOutputStream addCertificateDataToBaseImage(String promocode, String amount, String currencyAbbreviation) throws IOException {
        //File inputFile = ResourceUtils.getFile("static/input.png");
        InputStream inputFile = getClass().getClassLoader().getResourceAsStream("static/baseImage.png");
